...
<nav id="sidebar">
    <div class="p-4 pt-5">
        <a href="<?= site_url(); ?>" class="img logo rounded-circle mb-3" style="background-image: url(<?= base_url('assets/img/2.jpeg'); ?>);"></a>
        ...
        <div class="footer">
            <p>
                ...
                </script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib.com</a> | Repost by <a href='https://sukasuka.com/' title='Sukasuka.com' target='_blank'>denaakbar87@gmail.com</a>
