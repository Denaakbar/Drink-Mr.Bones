...
<head>
    ...
    <title><?= $title; ?></title>
    <link rel="shortcut icon" href="<?= base_url('assets/img/2.jpeg'); ?>">
    <!-- Bootstrap CSS -->
                        ...
                        <ul class="nav navbar-nav ml-auto mr-5">
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img src="<?= base_url('assets/foto/2.jpeg'); ?>" class="img-thumbnail" style="width:40px;height:40px;border-radius:50px"> <?= $this->session->userdata('User'); ?>
                                </a>
