...
<div class="alert alert-info" role="alert">
    ...
    <hr>
    <h4 class="alert-heading"><i class="fa fa-info-circle"></i> Selamat Datang di <b>Aplikasi Penjualan Berbasis Web Menggunakan PHP dan MySQL<br></br> pada Drink Mr. Bones Sukabumi</h4>
