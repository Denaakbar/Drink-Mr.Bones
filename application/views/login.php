...
<head>
    ...
    <title>Login Aplikasi Stok Barang Penjualan dan Pembelian rempeyek Heni Sukabumi</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center mt-5 mb-3">
                <img src="<?= base_url('assets/img/2.jpeg'); ?>" class="login" />
                <h3 class="text-white mt-2">Aplikasi Penjualan<br></br> Drink Mr. Bones Sukabumi</h3>
            ...
            <div class="col-md-4 col-sm-12 offset-md-4">
                ...
                <p class="text-white text-center">Copyright &copy;<script>
                    ...
                    </script> All rights reserved-powered by <br>Drink Mr. Bones Sukabumi
                </p>
            </div>
        </div>
    </div>
